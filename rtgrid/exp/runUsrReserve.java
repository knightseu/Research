 ...
 * runUsrReserve.java
 * Package:  rtgrid.exp
 * @author Xuan, 2006-12-17 
 */
public class runUsrReserve {
...
//						init cluster
		                ...
		                Vector tmpVector;
						if (bAllNode)
							tmpVector=sim.getFromFile(inputfile+".splitan");
						else 
							tmpVector=sim.getFromFile(inputfile+".split");
