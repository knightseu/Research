 ...
 * TestWorkload.java
 * Package:  rtgrid.test
 * @author Xuan, 2006-11-18 
 * 
 * This class tend to test the generated workload, collect the related workload.
 * 
 */
public class TestWorkload {
	static int totalWorkload=0;
	static int numOfTask=0;
	static double dcratio=0;
	static int totalDatasize=0;
	static int oldArrTime=0;
	static int totalInterarrivalTime=0;
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		...
		if (args.length==2) {
			...
			System.out.println("Usage: command configfile workloadfile");
			return;
		}
	...
	public static Vector getFromFile(String filename) {
