...
import rtgrid.scheduler.SchMN_SC;
...
public class testSC {
	...
	public static SimResult simrst;
	...
	public static void main(String[] args) {
		...
		Run(configfile,sch.getClass().getName(),4);
 ...
 * @param configfile
 * @param classname
 * @param index indicate which input file to run
 */
	public static final void Run(String configfile, String classname, int index) {
		...
		try {
			...
			//	for (int k=0;k<COMMON.PARA_EXP_ITERATION;k++) {
					...
					inputfile=COMMON.PARA_INPUT_FILENAME+j+"-"+index+".seq";
					//read tasks sequence
					NTList=sim.getFromFile(inputfile,COMMON.PARA_ST,COMMON.PARA_SC);					
					...
					p_details.print(simrst.getRejectRate()+ "		");
					System.out.print(simrst.getRejectRate()+ "		");
